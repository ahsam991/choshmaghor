...
**Version**: 2.0.0  
**Status**: Production Ready — Full Admin & Account Dashboard Overhaul

### 📝 Version History

- **v2.0.0** (May 2026) - Admin & Account Dashboard Overhaul
  - ✅ Complete admin dashboard rebuild with live stats, recent orders, quick actions
  - ✅ Dynamic product management — categories loaded from DB, two-column form layout
  - ✅ All admin views rewritten (products, orders, users, add/edit product)
  - ✅ Full admin CSS rewrite — removed duplicate rules, proper design tokens
  - ✅ Account page rebuilt — working profile update, password change (AJAX)
  - ✅ Fixed routing: SITE_URL, base-path stripping, admin/customer redirects
  - ✅ Fixed Logger.php `LOG_LEVEL_ALL` constant error
  - ✅ Fixed admin password hash corruption — credentials: admin@choshmazone.com / admin123
  - ✅ Session now stores user_email for account display
  - ✅ Mobile responsive: off-canvas sidebar, stacking grids, proper breakpoints (1024/768/480)
  - ✅ Bengali UI across all admin and account pages
  - ✅ Added `page-header`, `account-grid`, `account-sidebar` CSS to style.css
